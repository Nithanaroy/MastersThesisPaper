...
\begin{figure*}[t]
	\begin{subfigure}[t]{0.33\textwidth}
		\begin{tikzpicture}[every plot/.append style={very thick}, scale=0.7]
			...
			%    \legend{DisjointSearch, {\rrpspatial}, {\rrpsocial}, RRP}
