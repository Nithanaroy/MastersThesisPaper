...
\begin{figure*}[]
	\begin{subfigure}[t]{0.35\linewidth}\centering
		\begin{tikzpicture}[every plot/.append style={thick}, scale=0.7]
			\begin{axis}[
			    xlabel={K},
			    ylabel={Time (s)},
