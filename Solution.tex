...
\begin{algorithm}[t]
\caption{{\grpspatial} Initialization}
\begin{scriptsize}
\label{alg1}
\begin{algorithmic}[1]
\Function{{\grpspatial}}{$G, RF, M$}
...
All the other lines in the algorithm can be computed in constant time. The runtime of {\grpspatial} would hence be $O(V + E)$.
