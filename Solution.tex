...
\begin{figure}[t]
	\includegraphics[width=0.88\linewidth]{images/image05.eps}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.88\linewidth]{images/image06.eps}
    \caption{Multi layer grid index}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.88\linewidth]{images/traingle-inequality2.eps}
